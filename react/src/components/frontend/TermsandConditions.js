    ...
    <div className="terms-and-conditions">
      <div className="container">
        ...
        <div className="content">
          ...
          <p>
            If you would like to link to our Website, you must follow the conditions outlined in our linking policy:
          </p>
          <ul>
            <li>* The link must be fair and legal and must not damage our reputation or take advantage of it.</li>
            <li>* You must not establish a link that suggests any form of association, approval, or endorsement on our part where none exists.</li>
            <li>* You must not establish a link to our Website on any website that is not owned by you.</li>
            <li>* The linked website must comply with all applicable laws and regulations and must not contain any illegal, offensive, or controversial content.</li>
            <li>* By linking to our Website, you agree to be bound by and follow these linking terms and conditions.</li>
          </ul>
